...
<body class="py-5">
    ...
    <div class="mobile-menu md:hidden">
        ...
        <ul class="border-t border-white/[0.08] py-5 hidden">
            ...
            <li>
                <a href="<?php echo site_url('Kendaraan') ?>" class="menu">
                    <div class="menu__icon"> <i data-lucide="truck"></i> </div>
                    <div class="menu__title"> Kendaraan Saya </div>
                </a>
            </li>
            <li>
                <a href="<?php echo site_url('Userwp') ?>" class="menu">
                    <div class="menu__icon"> <i data-lucide="box"></i> </div>
                    <div class="menu__title"> Wajib Pajak </div>
                </a>
            </li>
            <li>
                <a href="<?php echo site_url('Faktur') ?>" class="menu">
                    <div class="menu__icon"> <i data-lucide="layout"></i> </div>
                    <div class="menu__title"> Informasi Tagihan </div>
                </a>
            </li>
            <li>
    ...
    <nav class="top-nav">
        <ul>
            <li>
                <a href="<?php echo site_url('User_home') ?>" class="top-menu">
                    <div class="top-menu__icon"> <i data-lucide="home"></i> </div>
                    <div class="top-menu__title"> Beranda </div>
                </a>
            </li>
            <li>
                <a href="<?php echo site_url('Kendaraan') ?>" class="top-menu">
                    <div class="top-menu__icon"> <i data-lucide="truck"></i> </div>
                    <div class="top-menu__title"> Kendaraan Saya </div>
                </a>
            </li>
            <li>
                <a href="<?php echo site_url('Userwp') ?>" class="top-menu">
                    <div class="top-menu__icon"> <i data-lucide="box"></i> </div>
                    <div class="top-menu__title"> Wajib Pajak </div>
                </a>
            </li>
            <li>
                <a href="<?php echo site_url('Faktur') ?>" class="top-menu top-menu--active">
                    <div class="top-menu__icon"> <i data-lucide="layout"></i> </div>
                    <div class="top-menu__title"> Informasi Tagihan </div>
                </a>
            </li>
        </ul>
    </nav>
