    ...
    <div class="intro-y box p-5 mt-5">
                ...
                <div class="dropdown w-1/2 sm:w-auto">
                    ...
                    <div class="dropdown-menu w-40">
                        <ul class="dropdown-content">
                            <li>
                                <a id="tabulator-print" href="<?php echo site_url('Wajib_pajak/print') ?>"
                                    class="dropdown-item" target="_BLANK">
                                    <i data-lucide="printer" class="w-4 h-4 mr-2"></i> Print
                                </a>
                            </li>
                            <li>
                                <a id="tabulator-export-xlsx" href="<?php echo site_url('Wajib_pajak/excel') ?>"
                                    class="dropdown-item">
        ...
        <div class="overflow-x-auto">
            <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                <table id="wp-table" class="table table-report -mt-2">
                    <thead>
                        <tr>
                                ...
                                <td class="table-report__action w-56">
                                    <div class="flex justify-center items-center">
                                        <a class="flex items-center text-danger"
                                            href="<?php echo site_url('Wajib_pajak/delete/' . $row['id_wp']) ?>"
                                            onclick="javascript: return confirm('Yakin mau menghapus <?php echo $row['id_wp'], ' ', $row['nama']; ?>')">
...
<script>
    document.getElementById('tabulator-html-filter-go').addEventListener('click', function () {
        ...
        var table = document.getElementById('wp-table');
