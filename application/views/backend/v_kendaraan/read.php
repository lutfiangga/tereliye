    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-5">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a href="<?php echo site_url('Kendaraan/create') ?>">
                <button class="btn btn-primary shadow-md mr-2">Tambah Kendaraan</button></a>
        </div>
    </div>
                ...
                <div class="dropdown w-1/2 sm:w-auto">
                    ...
                    <div class="dropdown-menu w-40">
                        <ul class="dropdown-content">
                            <li>
                                <a id="tabulator-print" href="<?php echo site_url('Kendaraan/print') ?>"
                                    class="dropdown-item" target="_BLANK">
                                    <i data-lucide="printer" class="w-4 h-4 mr-2"></i> Print
                                </a>
                            </li>
                            <li>
                                <a id="tabulator-export-xlsx" href="<?php echo site_url('Kendaraan/excel') ?>"
                                    class="dropdown-item">
                ...
                <table id="kendaraan-table" class="table table-report -mt-2">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center whitespace-wrap">Merek Kendaraan</th>
                                    ...
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center mr-3"
                                                href="<?php echo site_url('Kendaraan/edit/' . $row['id_kendaraan']) ?>">
                                                <i data-lucide="edit" class="w-4 h-4 mr-1"></i> Edit
                                            </a>
                                            <a class="flex items-center text-danger"
                                                href="<?php echo site_url('Kendaraan/delete/' . $row['id_kendaraan']) ?>"
                                                onclick="javascript: return confirm('Yakin Mau dihapus <?php echo $row['merk'], ' ', $row['no_pol']; ?>')">
...
<script>
    document.getElementById('tabulator-html-filter-go').addEventListener('click', function () {
        ...
        var table = document.getElementById('kendaraan-table');
