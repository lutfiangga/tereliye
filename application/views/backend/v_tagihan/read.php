...
<div class="content">
    <div class="intro-y flex flex-col sm:flex-row items-center mt-5">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a href="<?php echo site_url('Tagihan/create') ?>"> <button class="btn btn-primary shadow-md mr-2">Buat
                    Tagihan</button></a>
        </div>
    </div>
    ...
    <div class="intro-y box p-5 mt-5">
                ...
                <div class="dropdown w-1/2 sm:w-auto">
                    ...
                    <div class="dropdown-menu w-40">
                        <ul class="dropdown-content">
                            <li>
                                <a id="tabulator-print" href="<?php echo site_url('Tagihan/print') ?>"
                                    class="dropdown-item" target="_BLANK">
                                    <i data-lucide="printer" class="w-4 h-4 mr-2"></i> Print
                                </a>
                            </li>
                            <li>
                                <a id="tabulator-export-xlsx" href="<?php echo site_url('Tagihan/excel') ?>"
                                    class="dropdown-item">
        ...
        <div class="overflow-x-auto">
            <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                <table id="tagihan-table" class="table table-report -mt-2">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center whitespace-nowrap">NPWP</th>
                            <th class="text-center whitespace-wrap">Uraian Tagihan</th>
                            <th class="text-center whitespace-wrap">Virtual Account</th>
                            <th class="text-center whitespace-wrap">Jumlah Bayar</th>
                            <th class="text-center whitespace-nowrap">Status</th>
                            <th class="text-center whitespace-wrap">Tanggal Pembayaran</th>
                                ...
                                <td class="table-report__action w-56">
                                    <div class="flex justify-center items-center">
                                        <a class="flex items-center mr-3"
                                            href="<?php echo site_url('Tagihan/edit/' . $row['id_kwitansi']) ?>"> <i
                                                data-lucide="edit" class="w-4 h-4 mr-1"></i> Edit </a>
                                        <a class="flex items-center text-danger"
                                            href="<?php echo site_url('Tagihan/delete/' . $row['id_kwitansi']) ?>"
                                            onclick="javascript: return confirm('Yakin Mau dihapus <?php echo $row['id_kwitansi'], ' dengan NPWP ', $row['id_wp']; ?>')">
...
<script>
    document.getElementById('tabulator-html-filter-go').addEventListener('click', function () {
        ...
        var table = document.getElementById('tagihan-table');
